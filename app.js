...
const { createQrisTopupFlowService } = require('./src/services/qrisTopupFlowService');
const {
...
const qrisInvoiceBuilderService = createQrisInvoiceBuilderService({
  getGopayApiKey,
...
processQrisTopupInvoice = async function processQrisTopupInvoice(ctx, baseAmount, forcedUniqueSuffix = null) {
  return qrisTopupFlowService.processQrisTopupInvoice(ctx, baseAmount, forcedUniqueSuffix, {
    bot,
    db,
    logger,
    globalState: global,
...
async function createQrisInvoice(baseAmount, noteOrReference, forcedUniqueSuffix = null) {
  return qrisInvoiceBuilderService.createQrisInvoice(baseAmount, noteOrReference, forcedUniqueSuffix);
}
